...
#Original author: Yves G. <theYinYeti@yalis.fr>
#Original url: "https://yalis.fr/git/yves/pyruse"
#Modify by: Stefal
#Modify url:"https://github.com/Stefal/pyruse/"
...
package() {
  ...
  chmod 755 "${pkgdir}/usr/bin/"pyruse*
